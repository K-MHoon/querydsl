...
//        }
    ...
    /**
     * 런타임 전이 아닌, 컴파일에서 오류가 나기 때문에, 더 좋다.
     */
    @Test
    ...
    public void bulkAdd() {
        long count = queryFactory
                .update(member)
                .set(member.age, member.age.add(1)) // minus는 -1로, 곱하기는 multiply
                .execute();
    }
